...
Pada tulisan sebelumnya saya sudah memperlihatkan bagaimana saya<!--more--> merotasi sebuah objek menggunakan quaternion. Dan pada kesempatan kali ini saya akan memperilhatkan kekurangan dari cara merotasi objek saya sebelumnya dan bagaimana cara untuk menangani kekurangan tersebut. 
...
Bagaimana, nampak halus kan? Spherical Linear Interpolation (SLERP) sendiri adalah metode interpolasi yang digunakan untuk melakukan interpolasi antara dua quaternion atau vektor. Yang berguna dalam robotika untuk interpolasi rotasi, grafika komputer, animasi, dan game.
